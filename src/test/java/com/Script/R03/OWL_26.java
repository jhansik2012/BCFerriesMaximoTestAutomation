...
public class OWL_26 extends ActionEngine {

	@SuppressWarnings("static-access")
	@Test
	@Parameters({ "browser" })
	public void OWL_26(String browser, Method method) throws Throwable {
		...
		try {
			...
			lost_And_Found.generateReport();

			// This Method is used to Cancel Reports
			lost_And_Found.reportsCancel();
