...
public class OWL_250 extends ActionEngine {

	@SuppressWarnings("static-access")
	@Test
	@Parameters({ "browser" })
	public void OWL_250(String browser,Method method) throws Throwable {
		...
		try {
	        ...
	        //This method is used to add attachments
//			DrillLog.drillLogAttachNewAttachments();
