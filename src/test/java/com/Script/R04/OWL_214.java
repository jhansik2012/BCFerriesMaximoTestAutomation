...
public class OWL_214 extends ActionEngine {
	
	@SuppressWarnings("static-access")
	@Test
	@Parameters({ "browser" })
	public void OWL_214(String browser,Method method) throws Throwable {
		...
		try {
			...
			String LACclassification = tstData.get("LACclassification");				
			...
			String RenewalDays = tstData.get("RenewalDays");
			...
			// This method is used to enter values in License and Certificate 
			...
			// This method is used to enter Renewal Days in License and Certificate 
			license_And_Certificate_BCF.LicenseAndCertificate_RenewalNotification(RenewalDays);
			
			// This method is used to Select Classification in License and Certificate
			license_And_Certificate_BCF.selectClassification(LACclassification);
