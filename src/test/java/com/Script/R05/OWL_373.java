...
public class OWL_373 extends ActionEngine {
	
	@SuppressWarnings("static-access")
	@Test
	@Parameters({ "browser" })
	public void OWL_373(String browser,Method method) throws Throwable {
		...
		try {
			...
			// This Method is used to Add Findings for 2Rows
			InspectionsAndMeetings.AddFindings(ItemCode1,ItemCode2, Finding1,Finding2,CorrectiveAction1,CorrectiveAction2);	
					
			// This Method is used to enter Action owner
			InspectionsAndMeetings.EnterActionOwner(Owner1,Owner2);	
