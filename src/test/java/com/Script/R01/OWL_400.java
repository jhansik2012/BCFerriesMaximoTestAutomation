...
public class OWL_400 extends ActionEngine {

	@SuppressWarnings("static-access")
	@Test
	@Parameters({ "browser" })
	public void OWL_400(String browser, Method method) throws Throwable {
...
//			String ShiftLogID_s = DailyLog.DailyLog_ReadReturnShiftLogID();
			...
			// This Method is used to click on Run Reports
			DailyLog.ClickOnRunReports();

			// This Method is used to Generate Crew Competences Report
//			DailyLog.GenerateCrewCompetenciesReport();

			// This Method is used to Generate Daily Log Summary Report
//			DailyLog.GenerateDailyLogSummaryReport();

			// This Method is used to Generate Muster List Report
			DailyLog.GenerateMusterListReport();

			// This Method is used to Generate Passengers Count By Date Report
			DailyLog.GeneratePassengersCountsByDateReport();

			// This Method is used to Generate Ramp Assignment Report
//			DailyLog.GenerateRampAssignmentReportReport();
//
			//This Method is used to cancel the reports
			DailyLog.RunReport_ClickCancel();
